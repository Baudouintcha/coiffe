...
<head>
    ...
    <style>
        ...
        .nav-logo { height: 45px; margin-right: 12px; cursor: pointer; transition: 0.3s; }
        ...
        .sidebar a:hover { color: var(--gold); background-color: #111; padding-left: 45px; }
        ...
        .btn-gold { background-color: var(--gold); color: black; font-weight: bold; border: none; }
        
        /* Animation pour le dropdown About Us */
        #navbarHeader { transition: all 0.4s ease-in-out; }
    </style>
</head>
<body>
...
<div id="mySidebar" class="sidebar">
    ...
    <?php if(!isset($_SESSION['user_id'])): ?>
        <a href="inscription.php" class="text-warning"><i class="bi bi-person-plus"></i> Créer un compte</a>
    ...
    <a href="contact.php" class="mt-2 small text-secondary">📞 Support 24/7</a>
</div>
